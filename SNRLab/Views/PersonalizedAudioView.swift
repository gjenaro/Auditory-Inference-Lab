...
struct PersonalizedAudioView: View {
    ...
    @AppStorage("auditoryinference.personalizedAudio.pureToneSource.v1") private var selectedPureToneSource = "latest"
    @AppStorage("auditoryinference.personalizedAudio.maximumBoost.v1") private var maximumBoostDB = 6.0
